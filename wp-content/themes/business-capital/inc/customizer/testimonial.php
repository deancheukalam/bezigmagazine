...
class Business_Capital_Testimonial_Options {
	...
	public function add_defaults( $default_options ) {
		$defaults = array(
			'business_capital_testimonial_visibility' => 'disabled',
			'business_capital_testimonial_number'     => 4,
		);
	...
	public function register_options( $wp_customize ) {
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				...
				'settings'          => 'business_capital_testimonial_section_top_subtitle',
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				'settings'          => 'business_capital_testimonial_section_title',
				'type'              => 'text',
				'sanitize_callback' => 'business_capital_text_sanitization',
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				'settings'          => 'business_capital_testimonial_section_subtitle',
				'type'              => 'text',
				'sanitize_callback' => 'business_capital_text_sanitization',
		...
		Business_Capital_Customizer_Utilities::register_option(
			array(
				'settings'          => 'business_capital_testimonial_number',
				'type'              => 'number',
		...
		$numbers = business_capital_gtm( 'business_capital_testimonial_number' );
		...
		for( $i = 0, $j = 1; $i < $numbers; $i++, $j++ ) {
			Business_Capital_Customizer_Utilities::register_option(
				array(
					...
					'sanitize_callback' => 'absint',
					'settings'          => 'business_capital_testimonial_page_' . $i,
	...
	public function is_testimonial_visible( $control ) {
		return ( business_capital_display_section( $control->manager->get_setting( 'business_capital_testimonial_visibility' )->value() ) );
	}
}
 ...
 * Initialize class
 */
$business_capital_ss_testimonial = new Business_Capital_Testimonial_Options();
