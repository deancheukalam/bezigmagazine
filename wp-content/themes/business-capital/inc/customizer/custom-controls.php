<?php
/**
 * Business CapitalCustomizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	 class Business_Capital_Image_Checkbox_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_image_checkbox';
	 ...
	 */
	 class Business_Capital_Text_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_text_radio_button';
	 ...
	 */
	class Business_Capital_Image_Radio_Button_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_image_radio_button';
	 ...
	 */
	class Business_Capital_Simple_Notice_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_simple_notice';
	 ...
	 */
	class Business_Capital_Slider_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_slider_control';
	 ...
	 */
	class Business_Capital_Toggle_Switch_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_toggle_switch';
	 ...
	 */
	class Business_Capital_Sortable_Repeater_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_sortable_repeater';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->button_labels = wp_parse_args( $this->button_labels,
				array(
					'add' => esc_html__( 'Add', 'business-capital' ),
				)
			);
		}
	 ...
	 */
	class Business_Capital_Dropdown_Select2_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_dropdown_select2';
	 ...
	 */
	class Business_Capital_Dropdown_Posts_Custom_Control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_dropdown_posts';
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			// Get our Posts
			$this->posts = Business_Capital_Customizer_Utilities::get_posts_as_array( $this->input_attrs );
		}
	 ...
	 *
	 */
	class Business_Capital_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business-capital-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="business_capital_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	class Business_Capital_TinyMCE_Custom_control extends WP_Customize_Control {
		/**
		 * The type of control being rendered
		 */
		public $type = 'business_capital_tinymce_editor';
		...
		public function to_json() {
			parent::to_json();
			$this->json['businessCapitaltinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['businessCapitaltinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['businessCapitalmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
	 ...
	 */
	class Business_Capital_Note_Control extends WP_Customize_Control {
		public $type = 'business_capital_description';
	 ...
	 */
	if ( ! function_exists( 'business_capital_url_sanitization' ) ) {
		function business_capital_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'business_capital_switch_sanitization' ) ) {
		function business_capital_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'business_capital_radio_sanitization' ) ) {
		function business_capital_radio_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'business_capital_text_sanitization' ) ) {
		function business_capital_text_sanitization( $input ) {
	 ...
	 */
	function business_capital_sanitize_select( $input, $setting ) {
	 ...
	 */
	function business_capital_sanitize_map_code( $input ) {
		// allow iframe.
